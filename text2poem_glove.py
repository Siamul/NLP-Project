...
with open(glove_model_name.split('.')[0] + '_' + glove_model_name.split('.')[1] + '_nonrhythm_output.txt', 'w') as outputFile:
...
with open(glove_model_name.split('.')[0] + '_' + glove_model_name.split('.')[1] + '_rhythm_output.txt', 'w') as outputFile:
